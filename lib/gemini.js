console.log('gemini.js loading...');
function callGeminiAPI() {
  console.log('dummy callGeminiAPI running');
...
async function callGeminiAPI(prompt) {
  try {
    const model = genAI.getGenerativeModel({ model: "gemini-1.5-flash" }); // double check model here
